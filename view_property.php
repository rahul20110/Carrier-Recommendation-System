...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <form action="pay.php" method="post" class="flex-btn">
         ...
         ?>
         <input type="hidden" name="get_id" value="<?php echo $_GET['get_id']; ?>">

         <input type="submit" value="Buy" name="buy_press" class="btn">


      </form>

      <form action="report_property.php" method="post" class="flex-btn">
      <!-- <i class="fa-solid fa-circle-exclamation"></i> -->
         <input type="hidden" name="property_id" value="<?php echo $property_id; ?>">
         <input type="submit" value="Report Property"  name="report" class="btn report-btn " style="width: 20%;" onclick="return confirm('report this listing ?');">
      </form>

      <form action="report_user.php" method="post" class="flex-btn">
      <!-- <i class="fa-solid fa-circle-exclamation"></i> -->
         <input type="hidden" name="property_id" value="<?php echo $property_id; ?>">
         <input type="hidden" name="user_id" value="<?php echo $fetch_user['id']; ?>">
         <input type="submit" value="report User"  name="report_user" class="btn report-btn " style="width: 20%;" onclick="return confirm('report this user ?');">
      </form>
