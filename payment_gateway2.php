...
<div class="payment">
   <form action="verify2.php" method="POST" name="member_signu">
	<script
...
<input type="hidden" name="callback_url" value="verify2.php">
<input type="hidden" name="cancel_url" value="verify2.php">
